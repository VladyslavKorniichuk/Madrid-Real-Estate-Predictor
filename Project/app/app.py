...
with tab4:
    ...
    if st.button("Pokaz MAE error oraz RMSE error "):
         matrix_error = pd.DataFrame({
              "Model": ["Random Forest", "Linear Regression", "ANN", "ANN 2"],
              "MAE Error":[110780.73, 195820.80,136807.18,157531.81],
              "RMSE Error":[248478.64, 347034.85, 389466.64, 324476.40]})
         st.table(matrix_error)